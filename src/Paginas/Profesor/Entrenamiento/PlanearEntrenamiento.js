                ...
                <form className="container-contact100" action="">
                    <div>
                        ...
                        <div className="form-group ">
                            <label className="App-subtitulo2 " htmlFor="fotoPerfil">Planear Entrenamiento</label>
                        </div>
                        ...
                        <div className="d-flex flex-wrap">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <div className="form-group margin">
                                        <textarea className="style-0 margin Input-Style textinput2" placeholder="Digita la planeación de entrenamiento del día seleccionado en este apartado."></textarea>
                                    </div>
                                </div>
                            </div>

                ...
                <div className="container-contact100 ">
                    ...
                    <form className="container-contact100 " action="">
                        ...
                        <div className="form-group margin">
                            <label className="App-subtitulo2 " for="fotoPerfil">FOTO DE PERFIL:</label>
                        ...
                        <div className="form-group margin">
                            <label className="App-subtitulo2 " for="docIdentidad">DOCUMENTO DE IDENTIDAD:</label>
                        ...
                        <div className="form-group margin">
                            <label className="App-subtitulo2" for="regCivil">REGISTRO CIVIL:</label>
                        ...
                        <div className="form-group margin">
                            <label className="App-subtitulo2" for="cerEstudiantil">CERTIFICADO ESTUDIANTIL</label>
                        ...
                        <div className="form-group margin">
                            <label className="App-subtitulo2" for="cerMedico">CERTIFICADO MEDICO</label>
                            <input onChange={this.onKeyPress('cerMedico')} type="file" className="form-control Input-Style margin" id="cerMedico" name="cerMedico" />
                        </div>
                        <div className="form-group margin">
                            <label className="App-subtitulo2" for="pasaporte">PASAPORTE</label>

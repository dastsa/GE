                    ...
                    <form className="container-contact100 " action="">
                        <div id="seccion1">
                            <div className="form-group">
                                <label htmlFor="tipoDocP" className="App-subtitulo2">TIPO DE DOCUMENTO:</label>
                                ...
                                {datos.map((data) => {
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="lugarExp" className="App-subtitulo2">LUGAR DE EXPEDICION:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="fechaExp" className="App-subtitulo2">FECHA DE EXPEDICION:</label>
                                ...
                                <div id="seccion2">
                                    <div className="form-group">
                                        <label htmlFor="nomAcu" className="App-subtitulo2">NOMBRES:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="apeAcu" className="App-subtitulo2">APELLIDOS:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="profesionAcu " className="App-subtitulo2">PROFESION:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="ciudadNac" className="App-subtitulo2">CORREO ELECTRONICO:</label>
                                ...
                                <div id="seccion3">
                                    <div className="form-group">
                                        <label htmlFor="direccionAcu" className="App-subtitulo2">DIRECCION:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="barrioAcu" className="App-subtitulo2">BARRIO:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="codPostalAcu" className="App-subtitulo2">CODIGO POSTAL:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="estratoAcu" className="App-subtitulo2">ESTRATO:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="telFijoAcu" className="App-subtitulo2">TELEFONO FIJO:</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="celularAcu" className="App-subtitulo2">CELULAR:</label>
